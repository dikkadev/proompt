	...
	theme: {
		...
		extend: {
			colors: {
				...
				// Variable states for prompt management
				variable: {
					provided: 'hsl(var(--variable-provided))',
					default: 'hsl(var(--variable-default))',
					missing: 'hsl(var(--variable-missing))'
				},
			...
			backgroundImage: {
				...
				'gradient-overlay': 'linear-gradient(180deg, transparent, hsl(var(--foreground) / 0.05))'
			}
		}
	},
